...
/**
 * Controller class for the BranchManager Home Page.
 * This class handles the interaction logic for the BranchManagerHomePage.fxml file.
 */
public class CEOHomePageController{
    ...
    @FXML
    private Button viewQuarterlyReportButton;

    @FXML
    private Button CompareReportsButton;
