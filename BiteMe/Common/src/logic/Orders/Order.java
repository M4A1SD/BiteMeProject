...
public class Order implements Serializable {
	...
	private int orderId=(int) serialVersionUID;
	...
	// Order updatedOrder = new Order("", orderNumber, price, 0, address); //
	// Assuming restaurant and list number are not required here
	...
	public Order(int numOfItems, double total_price, OrderStatus status, String restaurantId, int deliveryID,
			TypeOfOrder type) {
		super();
		NumOfItems = numOfItems;
		Status = status;
	...
	public void setAskedByCustomerTime(String askedByCustomerTime) {
		this.AskedByCustomerTime=Time.valueOf(askedByCustomerTime);
	}
