...
//	Float monthlyComissionPercent;
	...
	public Supplier(String userName, String password, String firstName, String lastName, String id, String email,
					...
					BranchLocation branchLocation, String role, UserStatus status,
					String restaurantName, ArrayList<Product> Menu, String relatedBranch) 
	{
		super(userName, password, firstName, lastName, id, email, phoneNumber, userType, organization, branchLocation, role, status);
